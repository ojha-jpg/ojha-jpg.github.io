  ...
  features: [
    {
      ...
      geometry: {
        type: "Point",
        coordinates: [85.323413991128874, 27.667400472275414],
      },
    },
  ],
};
...
var map = L.map("map", {
  ...
  [27.652676694874124, 85.29601111951571],
  [27.68689909210162, 85.3596569111411],
]);
...
var img_bounds_2yrs_depth_12 = [
  [27.635389976525275, 85.27984871577571],
  [27.700575495053446, 85.3579619598335],
];
var layer_2yrs_depth_12 = new L.imageOverlay(
  img_2yrs_depth_12,
  ...
  var popupContent =
    ...
    '</td>\
                    ...
                    <tr>\
                        ...
                        <td>' +
    (feature.properties["2yrs Depth"] !== null
      ? autolinker.link(feature.properties["2yrs Depth"].toLocaleString())
      : "") +
    '</td>\
                    </tr>\
                    <tr>\
                        ...
                        <td>' +
    (feature.properties["10yr Depth"] !== null
      ? autolinker.link(feature.properties["10yr Depth"].toLocaleString())
      : "") +
    '</td>\
                    </tr>\
                    <tr>\
                        ...
                        <td>' +
    (feature.properties["50yr Depth"] !== null
      ? autolinker.link(feature.properties["50yr Depth"].toLocaleString())
      : "") +
    '</td>\
                    </tr>\
                    <tr>\
                        ...
                        <td>' +
    (feature.properties["100yrs Dep"] !== null
      ? autolinker.link(feature.properties["100yrs Dep"].toLocaleString())
      : "") +
    '</td>\
                    </tr>\
                    <tr>\
    ...
    (feature.properties["Location"] !== null
      ? autolinker.link(feature.properties["Location"].toLocaleString())
      : "") +
    "</td>\
                    </tr>\
                </table>";
...
layerSelect.addEventListener("change", function () {
  ...
  if (
    selectedLayer == "2_depth" ||
    selectedLayer == "10_depth" ||
    selectedLayer == "50_depth" ||
    selectedLayer == "100_depth"
  ) {
  ...
  if (
    selectedLayer == "2_velocity" ||
    selectedLayer == "10_velocity" ||
    selectedLayer == "50_velocity" ||
    selectedLayer == "100_velocity"
  ) {
  ...
  if (selectedLayer === "100_velocity") {
    ...
    var img_bounds_100yrs_velocity_1 = [
      [27.641824128073083, 85.30769894040846],
      [27.689362979616487, 85.33608898503],
    ];
    var layer_100yrs_velocity_1 = new L.imageOverlay(
      img_100yrs_velocity_1,
    ...
    var img_bounds_50yrs_velocity_2 = [
      [27.641824128073083, 85.30769894040846],
      [27.689362979616487, 85.33608898503],
    ];
    var layer_50yrs_velocity_2 = new L.imageOverlay(
      img_50yrs_velocity_2,
    ...
    var img_bounds_10yrs_velocity_3 = [
      [27.641824128073083, 85.30769894040846],
      [27.689362979616487, 85.33608898503],
    ];
    var layer_10yrs_velocity_3 = new L.imageOverlay(
      img_10yrs_velocity_3,
    ...
    var img_bounds_2yrs_velocity_4 = [
      [27.635389976525275, 85.27984871577571],
      [27.700575495053446, 85.3579619598335],
    ];
    var layer_2yrs_velocity_4 = new L.imageOverlay(
      img_2yrs_velocity_4,
    ...
    var img_bounds_2yrs_depth_mono_8 = [
      [27.635389976525275, 85.27984871577571],
      [27.700575495053446, 85.3579619598335],
    ];
    var layer_2yrs_depth_mono_8 = new L.imageOverlay(
      img_2yrs_depth_mono_8,
    ...
    var img_bounds_10yrs_depth_mono_7 = [
      [27.635389976525275, 85.27984871577571],
      [27.700575495053446, 85.3579619598335],
    ];
    var layer_10yrs_depth_mono_7 = new L.imageOverlay(
      img_10yrs_depth_mono_7,
    ...
    var img_bounds_50yrs_depth_mono_6 = [
      [27.641824128073083, 85.30769894040846],
      [27.689362979616487, 85.33608898503],
    ];
    var layer_50yrs_depth_mono_6 = new L.imageOverlay(
      img_50yrs_depth_mono_6,
    ...
    var img_bounds_100yrs_depth_mono_5 = [
      [27.641824128073083, 85.30769894040846],
      [27.689362979616487, 85.33608898503],
    ];
    var layer_100yrs_depth_mono_5 = new L.imageOverlay(
      img_100yrs_depth_mono_5,
    ...
    var img_bounds_100yrs_depth_9 = [
      [27.641824128073083, 85.30769894040846],
      [27.689362979616487, 85.33608898503],
    ];
    var layer_100yrs_depth_9 = new L.imageOverlay(
      img_100yrs_depth_9,
    ...
    var img_bounds_50yrs_depth_10 = [
      [27.641824128073083, 85.30769894040846],
      [27.689362979616487, 85.33608898503],
    ];
    var layer_50yrs_depth_10 = new L.imageOverlay(
      img_50yrs_depth_10,
    ...
    var img_bounds_10yrs_depth_11 = [
      [27.635389976525275, 85.27984871577571],
      [27.700575495053446, 85.3579619598335],
    ];
    var layer_10yrs_depth_11 = new L.imageOverlay(
      img_10yrs_depth_11,
